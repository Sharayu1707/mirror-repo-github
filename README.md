...
```
cd existing_repo
git remote add origin https://gitlab.com/sharayu1707/mirror-repo-gitlab.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sharayu1707/mirror-repo-gitlab/-/settings/integrations)
